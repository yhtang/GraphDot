...
import pytest
import exrex
from graphdot.codegen.cpptool import cpptype, decltype, _assert_is_identifier


def test_assert_is_indentifier():
    _assert_is_identifier('a')
    _assert_is_identifier('a1')
    _assert_is_identifier('a_')
    _assert_is_identifier('_a')
    _assert_is_identifier('')
    with pytest.raises(ValueError):
        _assert_is_identifier('a!')
    with pytest.raises(ValueError):
        _assert_is_identifier('!a')
    with pytest.raises(ValueError):
        _assert_is_identifier('1a')
