...
class MicroKernel(ABC):
    ...
    def create(name, desc, expr, vars, *hyperparameter_specs):
        ...
        class Kernel(MicroKernel, metaclass=CppType):
    ...
    def __add__(self, k):
        ...
        return MicroKernelExpr.add(
            self,
            k if isinstance(k, MicroKernel) else Constant(k)
        )
    ...
    def __pow__(self, c):
        ...
        if isinstance(c, (int, float)):
            return MicroKernelExpr.pow(self, Constant(c))
